...
RSpec.describe AuthorizeApiRequest do
  ...
  subject(:request_object) { described_class.new(headers: header) }
    ...
    context "when invalid request" do
      ...
      context "when invalid token" do
        subject(:invalid_request_object) do
          described_class.new(headers: { "Authorization" => token_generator(user_id: 5) })
        end
      ...
      context "fake token" do
        ...
        subject(:invalid_request_object) { described_class.new(headers: header) }
